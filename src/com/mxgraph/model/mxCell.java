...
public class mxCell implements mxICell, Cloneable, Serializable
{
   ...
   protected Object topOwner=null;
   protected Object leftOwner=null;
   protected Object rightOwner=null;
   protected Object bottomOwner=null;


public void setTopOwner(Object topOwner) {
	this.topOwner = topOwner;
}

public Object getTopOwner() {
	return topOwner;
}

public boolean hasTopOwner() {
	if (topOwner != null) {
		return true;
	}
	return false;
...
public void setLeftOwner(Object leftOwner) {
	this.leftOwner = leftOwner;
}

public Object getLeftOwner() {
	return leftOwner;
}
...
public void setRightOwner(Object rightOwner) {
	this.rightOwner = rightOwner;
}

public Object getRightOwner() {
	return rightOwner;
}

public boolean hasRightOwner() {
	if (rightOwner != null) {
		return true;
	}
	return false;
...
public void setBottomOwner(Object bottomOwner) {
	this.bottomOwner = bottomOwner;
}

public Object getBottomOwner() {
	return bottomOwner;
}

public boolean hasBottomOwner() {
	if (bottomOwner != null) {
		return true;
	}
	return false;
...
public ArrayList<Object> ssList = new ArrayList<>();

public void setSS(Object ss) {
	 ssList.add(ss);
}
public Object getSS(Object ss) {
	int indexSS = ssList.indexOf(ss);
	return ssList.get(indexSS);

}
public void removeSS(Object ss) {
	int indexSS = ssList.indexOf(ss);
	ssList.remove(indexSS);
}

private Boolean notNull = false;

public void setNotNull(Boolean boo){
	this.notNull = boo;
}

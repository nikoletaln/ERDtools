...
//font dashed underline
	public static final int FONT_UNDERLINE_LOW_DASHED = 6;
	 ...
	 */
	public static final String SHAPE_DOUBLE_RECTANGLE = "doubleRect";
	 ...
	 */
	public static final String SHAPE_DOUBLE_ELLIPSE = "doubleEl";
    ...
    public static final String ARROW_ARC = "arrowarc";
	public static final String SHAPE_DOUBLE_RHOMBUS = "doubleRh";

	public static final String D_CIRCLE = "d_circle";
	public static final String O_CIRCLE = "o_circle";
	public static final String U_CIRCLE = "U_circle";
	public static final String PARTIAL = "partial";
	public static final String PRIMARY = "primary";
	public static final String UNIQUE = "unique";
	public static final String DASHED = "dashed";
	public static final String UN_DL = "un_dl";
